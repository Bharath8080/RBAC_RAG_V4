...
def show_login_form():
    ...
    st.markdown('<div style="text-align: center; margin-top: 20px; margin-bottom: 17px;"><h1 style="font-size: 3rem;">🔒</h1></div>', unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: center; margin-bottom: 20px; color: #f73e05; font-weight: bold; font-family: Arial Black, sans-serif;'>Department Portal</h1>", unsafe_allow_html=True)
